                ...
                >
                  <CardHeader className="pb-2">
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      {plugin.badge && (
                        <Badge variant="secondary" className="shrink-0 bg-teal-100 text-teal-800 border-0">
                          {plugin.badge}
                        </Badge>
                      )}
                    </div>
                    <CardTitle className="text-xl text-slate-900">{plugin.nameAr}</CardTitle>
                    <CardDescription className="text-slate-600 mt-1">{plugin.description}</CardDescription>
                  ...
                  <CardContent className="pt-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        {plugin.id === "api" ? "التوثيق والـ API" : plugin.id === "socialSellers" ? "عرض الحلول" : "فتح التوثيق"}
                      </Button>
                      <Button
                        variant="outline"
                        size="icon"
